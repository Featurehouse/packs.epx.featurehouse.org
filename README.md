...
2. **Upload a Minecraft-readable version** under `nopool/v2` folder. See the [Traditional Chinese version](https://github.com/Featurehouse/packs.epx.featurehouse.org/blob/master/public/nopool/v2/zh_tw.txt)
as an example.
...
Create a new object in [`translation_metadata.json`](https://github.com/Featurehouse/packs.epx.featurehouse.org/blob/master/public/v2/translation_metadata.json) - `other_i18n`. For example:
```json5
  {
    "other_i18n": {
      "lzh": [
